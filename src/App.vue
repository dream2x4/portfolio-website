...
<template>
  ...
  <div class="footer col-12 d-flex align-items-center justify-content-between">
    <p class="footer-text d-flex justify-content-start">© All rights reserved</p>
    ...
    <a class="d-flex align-items-center" href="#top">
      <p class="footer-text d-flex align-items-center justify-content-end">
        <svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" fill="currentColor" class="bi bi-arrow-up" viewBox="0 0 16 16">
